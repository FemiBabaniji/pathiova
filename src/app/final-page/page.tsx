          ...
          <Card className="w-full max-w-md mx-auto bg-white shadow-xl rounded-lg overflow-hidden">
            <CardContent className="p-8">
              ...
              <div className="space-y-4 mb-6">
                <Button variant="outline" className="w-full flex items-center justify-center space-x-2 h-12 text-base">
              ...
              <p className="mt-4 text-medium text-center text-gray-500">
                By clicking Sign up, I agree to Pathova's{' '}
                <a href="#" className="underline">Terms</a> and{' '}
                <a href="#" className="underline">Privacy Policy</a>
              </p>
              <p className="mt-6 text-sm text-center">
                Existing user? <a href="#" className="text-blue-600 underline">Sign in</a>
              </p>
            </CardContent>
          </Card>
        </motion.div>
      </div>
      <AnimatedCircle size="small" position="corner" />
    </div>
  )
}